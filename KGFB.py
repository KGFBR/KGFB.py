...
\033[1;37m    ######      ######     ########  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            NAME TA SUNEYA HOLA NI KGF BRAND HU
\033[1;37m Facebook:           VANDENA BUGIS
\033[1;37m Github  :            GITHUB CHAI KINA Chaiyo
\033[1;37m Speed   :            Jay KGF Van Speed lai
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/shuvam.sapkota.9?mibextid=ZbWKwL
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
        
def metho#!/usr/bin/python
#Original written By KGF BRAND
